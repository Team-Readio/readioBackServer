...
//              .and() (삭제) 람다식에선 필요없음
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                .requestMatchers(HttpMethod.GET, "/serviceCenter/notice/**").permitAll()
                                .requestMatchers(HttpMethod.POST, "/serviceCenter/notice/write").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/serviceCenter/notice/update").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/serviceCenter/notice/delete/**").hasRole("ADMIN")
                                .requestMatchers("/admin/**").permitAll()       // 관리자 관련 경로(권한 풀고 테스트하면 403뜨는게 정상임 )
